#!/usr/bin/env bash
# Tier A factory build: semver from git source via npm pack (local checkout only).
...
assert_tgz_has_member "${main_tgz}" package/bin/semver.js
